...
@Component({
  selector: 'app-modificar-consumible',
  templateUrl: './modificar-consumible.component.html',
  styleUrls: ['./modificar-consumible.component.css']
})
export class ModificarConsumibleComponent implements OnInit {
