...
@Component({
  selector: 'app-eliminar-consumible',
  templateUrl: './eliminar-consumible.component.html',
  styleUrls: ['./eliminar-consumible.component.css']
})
export class EliminarConsumibleComponent implements OnInit {
